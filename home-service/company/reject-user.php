...
$sql = "UPDATE get_service SET status='1' WHERE id_jobpost='$_GET[id_jobpost]' AND id_user='$_GET[id_user]'";
...
if($conn->query($sql) === TRUE) {
  ...
  if($result1->num_rows > 0) {
    while($row = $result1->fetch_assoc()) 
    {
		...
		// $subject = "Home Service - Application Rejected!";

		// $message = '
		
		// <html>
		// <head>
		// 	<title>Home Service - Application Rejected!</title>
		// <body>
